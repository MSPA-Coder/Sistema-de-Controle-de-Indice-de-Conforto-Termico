...
class TestDadosEntrada(TestCasePostgres):
    ...
    def test_quantidade_e_calculada_por_area_peso_especie_e_categoria(self):
        ...
        quantidades = []
        configs = []
        for categoria in ("abaixo_media", "media", "acima_media", "muito_acima_media"):
        ...
        calor_baixo = gerador.simular_animais(configs[0], instante, 25, 70, 5, random.Random(123))[
    ...
    def test_parametros_e_cidades_respeitam_a_especie(self):
        ...
        with self.assertRaisesRegex(dados_db.ConfiguracaoDadosEntradaError, "só se aplicam"):
            dados_db.salvar_configuracoes_zonas([{**base, "ordenhas_dia": 1}], [suinos])
    ...
    def test_sessao_geracao_permite_multiplos_lotes_na_mesma_conexao(self):
        ...
        def _medicao(hora):
            return {
                ...
                "tbs_externa_c": 25.0,
                "ur_externa_pct": 70.0,
                "ponto_orvalho_c": 19.0,
                "tbu_c": 20.0,
                "velocidade_vento_ms": 1.0,
                "precipitacao_mm": 0.0,
                "pressao_hpa": 930.0,
                "radiacao_w_m2": 0.0,
                "nebulosidade_pct": 0.0,
                "valor_indice": 73.0,
                "status_termico": "Conforto",
                "area_util_m2": 600.0,
                "densidade_categoria": "media",
                "densidade_animais_m2": 0.06,
                "quantidade_animais": 40,
                "atividade_predominante": "repouso",
                "alimentacao_kg": 0.0,
                "consumo_agua_l": 0.0,
                "animais_em_pe": 10,
                "animais_deitados": 30,
                "animais_em_ordenha": 0,
                "calor_sensivel_animais_w": 0.0,
                "calor_latente_animais_w": 0.0,
                "vapor_agua_animais_kg_h": 0.0,
                "origem_variaveis": origem_json,
                "indicador_qualidade": "reanálise_horária",
                "entradas_indice": {"tbs": 25.0, "tbu": 20.0},
                "simulation_seed": 1,
            }
