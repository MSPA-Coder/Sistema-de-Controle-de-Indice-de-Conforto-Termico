...
`scripts/provision-db-runtime.sh`); o superusuário fica no banco e nos
serviços `schema` e `db-provision`. Até 09/2026 a produção conectava como `conforto`, que a imagem
...
Só vale onde `DB_EXIGIR_PAPEL_RESTRITO=1`: o `schema` (Alembic) usa o papel
