...
CATEGORIAS_DENSIDADE = (
    ...
    MappingProxyType({"valor": "muito_acima_media", "rotulo": "Muito acima da média", "fator": 1.27}),
)
...
def calcular_lotacao(
    ...
    if modelo["tipo"] == "massa_viva":
        ...
        faixa = next(
            item for item in modelo["faixas"]
...
CIDADES_POR_ESPECIE = MappingProxyType({
    "frangos": (
        _cidade("Santa Maria de Jetibá", "ES", "3204559", 17_477_126, -20.02745, -40.74336, 713.0, "America/Sao_Paulo"),
        _cidade("São Bento do Una", "PE", "2613008", 14_933_819, -8.52278, -36.44444, 630.0, "America/Recife"),
        _cidade("Bastos", "SP", "3505807", 13_650_920, -21.92194, -50.73389, 460.0, "America/Sao_Paulo"),
        _cidade("Toledo", "PR", "4127700", 12_071_286, -24.71361, -53.74306, 562.0, "America/Sao_Paulo"),
        _cidade("Uberlândia", "MG", "3170206", 12_040_000, -18.91861, -48.27722, 867.0, "America/Sao_Paulo"),
    ),
    "bovinos": (
        _cidade("Marabá", "PA", "1504208", 52_480, -5.38146, -49.13232, 95.0, "America/Belem"),
        _cidade("Castro", "PR", "4104907", 47_033, -24.78927, -50.01225, 986.0, "America/Sao_Paulo"),
        _cidade("São Geraldo do Araguaia", "PA", "1507458", 46_970, -6.40056, -48.555, 131.0, "America/Belem"),
        _cidade("Patos de Minas", "MG", "3148004", 45_434, -18.57889, -46.51806, 842.0, "America/Sao_Paulo"),
        _cidade("Açailândia", "MA", "2100055", 44_748, -4.94667, -47.50472, 243.0, "America/Fortaleza"),
    ),
    "suinos": (
        _cidade("Toledo", "PR", "4127700", 949_984, -24.71361, -53.74306, 562.0, "America/Sao_Paulo"),
        _cidade("Uberlândia", "MG", "3170206", 623_933, -18.91861, -48.27722, 867.0, "America/Sao_Paulo"),
        _cidade("Marechal Cândido Rondon", "PR", "4114609", 576_000, -24.55611, -54.05667, 425.0, "America/Sao_Paulo"),
        _cidade("Concórdia", "SC", "4204301", 517_700, -27.23417, -52.02778, 592.0, "America/Sao_Paulo"),
        _cidade("Tapurah", "MT", "5108006", 407_087, -12.73714, -56.5136, 506.0, "America/Cuiaba"),
    ),
})
