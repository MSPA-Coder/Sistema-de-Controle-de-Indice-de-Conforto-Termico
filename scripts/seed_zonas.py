...
ZONAS = [
    {
        ...
        "sensores": [
            {
                "nome": "Sonda TBS/TBU 1 - Bulbo Seco",
                "modo_conexao": "rtu",
            ...
            {
                "nome": "Sonda TBS/TBU 1 - Bulbo Úmido",
                "modo_conexao": "rtu",
                "porta_serial": "/dev/ttyUSB0",
                "baud_rate": 9600,
                "unidade_id": 1,
    ...
    },
    {
        ...
        "sensores": [
            {
                "nome": "Sensor Temperatura Ambiente 1",
                "modo_conexao": "tcp",
                "host": "192.168.1.101",
                "porta": 502,
                "unidade_id": 1,
    ...
    },
    {
        ...
        "sensores": [
            {
                "nome": "Termômetro de Globo Negro 1",
                "modo_conexao": "rtu",
            ...
            {
                "nome": "Sensor Ponto de Orvalho 1",
                "modo_conexao": "rtu",
                "porta_serial": "/dev/ttyUSB1",
                "baud_rate": 19200,
                "unidade_id": 2,
    ...
    },
    {
        ...
        "sensores": [
            ...
            {
                "nome": "Sensor TBU Creche 2 - Baia A",
                "modo_conexao": "tcp",
                "host": "192.168.1.120",
                "porta": 502,
                "unidade_id": 1,
            ...
            },
            {
                ...
                "nome": "Sensor TBU Creche 2 - Baia B",
                "modo_conexao": "tcp",
                "host": "192.168.1.121",
                "porta": 502,
                "unidade_id": 1,
